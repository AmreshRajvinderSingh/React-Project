...
const Create=()=>{
    ...
    return(
      ...
      <form className="create-post" onSubmit={handleSubmit}>
        ...
        <input type="text" ref={userIdData} class="form-control" id="userId" placeholder="User Id"/>
       
      </div>
      <div class="mb-3">
        <label for="title" class="form-label">Post Title</label>
        <input type="text" ref={postTitleData} class="form-control" id="title" placeholder="What's in your mind ?"/>
       
      </div>
      <div class="mb-3">
        <label for="body" class="form-label">Post Content</label>
        <textarea rows="4" ref={postBodyData} type="text" class="form-control" id="body" placeholder="How about providing more words?"/>
       
      </div>
      <div class="mb-3">
        <label for="reactions" class="form-label">Reactions</label>
        <input type="text" ref={reactionsData} class="form-control" id="reactions" placeholder="Number of People Reacted ?"/>
       
      </div>
      <div class="mb-3">
        <label for="tags" class="form-label">HashTags</label>
        <input type="text" ref={tagsData} class="form-control" id="tags" placeholder="Eneter Tags using space"/>
